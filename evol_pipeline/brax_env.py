...
from tensorneat.problem import RLEnv
from tensorneat.problem.rl.rl_jit import norm_obs

class CustomBraxEnv(RLEnv):
    def __init__(
        self, 
        env_name: str = "ant", 
        ...
        **kwargs
        ...
        self.env = envs.create(env_name=env_name, backend=backend, **brax_args)
